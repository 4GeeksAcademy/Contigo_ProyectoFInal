...
Revision ID: 195f341858a8
Revises: 
Create Date: 2023-07-05 19:33:04.709394
...
def upgrade():
    ...
    sa.Column('ong', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['categoria'], ['categorias.descripcion'], ),
    sa.ForeignKeyConstraint(['ong'], ['ong.id'], ),
